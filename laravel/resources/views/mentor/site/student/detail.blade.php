...
@section('content')
      ...
      <div class="content">
	    ...
	    <div style="width:100%; text-align:right;">
                <button class="btn btn-info" onclick="location.href='{{route('mentor.resume.detail', ['id' => 1])}}'">Resume</button>
	    	<button class="btn btn-info" onclick="location.href='{{route('mentor.expericnes.student.list', ['id' => 1])}}'">Learning Outcomes</button>
                <button class="btn btn-info" onclick="location.href='{{route('mentor.review.detail', ['id' => 1])}}'">Review</button>
	    </div>
