                ...
                <div class="card-body">
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <textarea class="form-control" name="education" rows="10">Philosophy
...
International Area Studies</textarea>
                      ...
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <textarea class="form-control" name="course" rows="10">Philosophy
History and Anthropology
Literature and Linguistics
Modern Languages and Cultures
International Public Policy
...
International Area Studies</textarea>
                      ...
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <textarea class="form-control" name="skill" rows="10">Philosophy
History and Anthropology
Literature and Linguistics
Modern Languages and Cultures
International Public Policy
...
International Area Studies</textarea>
                      ...
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <textarea class="form-control" name="related_experience" rows="10">Philosophy
History and Anthropology
Literature and Linguistics
Modern Languages and Cultures
International Public Policy
...
International Area Studies</textarea>
                      ...
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <textarea class="form-control" name="additional_expericne" rows="10">Philosophy
History and Anthropology
Literature and Linguistics
Modern Languages and Cultures
International Public Policy
...
International Area Studies</textarea>
            	      ...
            	      <div style="width:100%; text-align:right;">
                		<button class="btn btn-info" onclick="location.href='/resume/'">Update</button>
               	      </div>
